...
const CommentReply = ({onReply}) => {
  return (
    <button onClick={onReply} className="flex justify-center items-center gap-2 cursor-pointer text-[#5357B6] font-medium hover:opacity-50 transition-opacity">
